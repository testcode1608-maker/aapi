...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<I18nContextValue>(() => ({ language, setLanguage, t: (key: string) => { const parts = key.split("."); const current = resolveKey(translations[language], parts); if (typeof current === "string") return current; const home = resolveKey(homeTranslations[language], parts); if (typeof home === "string") return home; const page = resolveKey(pagesTranslations[language], parts); if (typeof page === "string") return page; const extra = resolveKey(extraTranslations[language], parts); if (typeof extra === "string") return extra; const fallback = resolveKey(translations.ar, parts); if (typeof fallback === "string") return fallback; const homeFallback = resolveKey(homeTranslations.ar, parts); if (typeof homeFallback === "string") return homeFallback; const pageFallback = resolveKey(pagesTranslations.ar, parts); if (typeof pageFallback === "string") return pageFallback; const extraFallback = resolveKey(extraTranslations.ar, parts); return typeof extraFallback === "string" ? extraFallback : key; } }), [language]);
