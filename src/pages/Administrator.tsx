...
type Section = "dashboard" | "users" | "investors" | "projects" | "investments" | "requests" | "messages" | "documents" | "announcements" | "news";
...
export default function Administrator() {
  ...
  const section: Section = name && ["users", "investors", "projects", "investments", "requests", "messages", "documents", "announcements", "news"].includes(name) ? name : "dashboard";
  const names: Record<string, string> = {
    ...
    investments: t("admin.nav.investments"), requests: t("admin.nav.requests"), messages: t("admin.nav.messages"), documents: t("admin.nav.documents"), announcements: t("admin.nav.announcements"), news: t("admin.nav.news"), settings: t("admin.nav.settings")
  };
