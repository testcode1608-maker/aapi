...
function AdminRoute() {
  ...
  if (user.statut && String(user.statut).toLowerCase() !== "actif") return <Navigate to="/login" replace />;
...
function AppContent() {
  ...
  const isInvestorDashboard = location.pathname.startsWith("/investor/dashboard");
